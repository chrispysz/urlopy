    ...
    <div class="container">
        ...
        <form action="WorkerServlet" method="get">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="startDateInput" placeholder="np. 2025-06-15"/>
            </div>
            <div class="form-group">
                <label for="End">Do</label>
                <input type="text" class="form-control" name="endDateInput" placeholder="np. 2025-06-22"/>
            </div>
